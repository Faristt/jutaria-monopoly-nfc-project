...
🎮 Cara Penggunaan
1.Daftar Pemain: Klik "Daftar Pemain" dan tap kad NFC anda atau pilih "Daftar Manual".

2.Transaksi: Pilih "Terima" atau "Bayar". Sistem akan mensasarkan pemain yang sedang memegang giliran secara automatik. Tekan SAHKAN untuk tamat.

3.Penjara: Jika pemain masuk penjara, sistem akan mengunci tindakan mereka sehingga mereka bebas melalui balingan dadu atau bayaran denda.

4.Tamat Giliran: Tekan butang TAMAT GILIRAN >> untuk beralih ke pemain seterusnya.
